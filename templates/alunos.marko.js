...
function render(input, out, __component, component, state) {
  ...
  out.w("<!DOCTYPE html><html lang=pt-br><head><meta charset=UTF-8><meta http-equiv=X-UA-Compatible content=IE=edge><meta name=viewport content=\"width=device-width, initial-scale=1.0\"><title>Alunos</title><link rel=stylesheet href=https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/css/materialize.min.css><link href=https://fonts.googleapis.com/icon?family=Material+Icons rel=stylesheet></head><body><div class=container><div class=row><h1>Alunos <a class=\"btn-floating btn-large waves-effect waves-light red\" href=/aluno><i class=material-icons>add</i></a></h1></div><table><thead><th>Id</th><th>Nome</th><th>Curso</th><th>Opções</th></thead><tbody>");
  ...
  marko_forOf(data.results, function(aluno, index) {
    ...
    out.w("<tr><td>" +
      ...
      marko_attr("href", "/aluno/" + (aluno.id == null ? "" : aluno.id)) +
      "><i class=material-icons>edit</i></a><a class=\"btn-floating btn-small waves-effect waves-light red\" data-method=delete" +
      marko_attr("href", "/aluno/delete/" + (aluno.id == null ? "" : aluno.id)) +
